  ...
  return (
    <div className={classes.root}>
      <Typography variant="body1" gutterBottom>
        ...
        Little did I know at that time that I was meeting a high capacity person
        who would have a tremendous impact on my professional life. For a number
        of years, I observed Liennette build powerful admin and operations teams
        that increased the production of the entire company. Sales and service
        people alike respect her. Then in 2012 we joined forces in Building
        Quality Organizations through our Consulting Practice. Liennette’s
        principle area of financial expertise has benefited many of our clients
